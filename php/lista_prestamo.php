	...
	<section class="full-box cover dashboard-sideBar">
		...
		<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
                   ...
                   <div class="lista2">
                    <a href="prestamo-libro.php" class="btn btn-info">
			  			<i class="zmdi zmdi-plus"></i> &nbsp; AGREGAR NUEVO PRESTAMO
			  		</a>.
			  		</div>
    ...
    <hr class="hr">
     <div class="container">
      <table>
          <thead>
              <tr>
                  <th>ID_PRESTAMO</th><th>CARNET</th><th>ID_LIBRO</th><th>FECHA_INICIO</th><th>FECHA_DEVOLUCCION</th><th>ADMIN</th><th>ELIMINAR</th>
              </tr>
          </thead>
     <tbody>
                    <?php
        ...
        while($row=$consulta2->fetch_array(MYSQLI_ASSOC)){
            ...
            echo "<tr>
                ...
                <td>".$row['DUI']."</td>
                 ...
                 <td><a href='eliminarprestamo.php?ID_PRESTAMO=".$row['ID_PRESTAMO']."'>Eliminar Prestamo</a></td>
