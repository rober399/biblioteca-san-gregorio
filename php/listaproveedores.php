...
<body>
   ...
   <nav class="full-box dashboard-Navbar">
	...
	<section class="full-box cover dashboard-sideBar">
		...
		<ul class="list-unstyled full-box dashboard-sideBar-Menu">
           ...
           <a href="../RegistroAdmin.html"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Administradores</a>
                    ...
                    <center>
                    <a href="../proveedores.html" class="btn btn-info">
			  			<i class="zmdi zmdi-plus"></i> &nbsp; AGREGAR NUEVO PROVEEDOR
			  		</a>
   </center>
    <hr class="hr">
     <div class="container">
    ...
    require_once "conexionBD.php";      
        ...
        $consulta="SELECT ID_PROVEEDOR,NOMBRE FROM PROVEEDOR";
        ...
        while($row=$consulta2->fetch_array(MYSQLI_ASSOC)){
            ...
            echo "<tr>
                ...
                <td><a href='Actualizar-proveedor.php?ID_PROVEEDOR=".$row['ID_PROVEEDOR']."'>Actualizar</a></td>
