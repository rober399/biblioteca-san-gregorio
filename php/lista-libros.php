	...
	<section class="full-box cover dashboard-sideBar">
		...
		<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
                   ...
                   <div class="lista2">
                    <a href="nuevo-libro.php" class="btn btn-info">
			  			<i class="zmdi zmdi-plus"></i> &nbsp; AGREGAR NUEVO LIBRO
			  		</a>
			  		</div>
    ...
    <hr class="hr">
     <div class="container">
      <table>
          <thead>
              <tr>
                  <th>ID_LIBRO</th><th>NOMBRE</th><th>CATEGORIA</th><th>PROVEEDOR</th><th>N° EXISTENCIAS</th><th>ADMIN</th><th>ELIMINAR</th>
              </tr>
          </thead>
     <tbody>
                    <?php
    require_once "conexionBD.php";      
        ...
        while($row=$consulta2->fetch_array(MYSQLI_ASSOC)){
            ...
            echo "<tr>
                ...
                <td>".$row['N_EXISTENCIAS']."</td>
                <td>".$row['DUI']."</td>
                    
                
                 <td><a href='eliminarlibro.php?ID_LIBRO=".$row['ID_LIBRO']."'>Eliminar Libro</a></td>
