...
<body>
   ...
   <nav class="full-box dashboard-Navbar">
	...
	<section class="full-box cover dashboard-sideBar">
		...
		<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
                   ...
                   <div class="lista2">
                    <a href="../RegistroAdmin.html" class="btn btn-info">
    ...
    <hr class="hr">
     <div class="container">
      <table>
          <thead>
              <tr>
                  <th>DUI</th><th>Nombre</th><th>Apellido</th><th>Telefono</th><th>Direccion</th>
              </tr>
          </thead>
           <tbody>
                    <?php
    require_once "conexionBD.php";      
        ...
        $consulta="SELECT DUI,NOMBRES,APELLIDOS,TELEFONO FROM REGISTRO";
        ...
        while($row=$consulta2->fetch_array(MYSQLI_ASSOC)){
            ...
            echo "<tr>
                ...
                <td><a href='Actualizar-admin.php?DUI=".$row['DUI']."'>Actualizar</a></td>
                 <td><a href='eliminar-admin.php?DUI=".$row['DUI']."'>Eliminar</a></td>
