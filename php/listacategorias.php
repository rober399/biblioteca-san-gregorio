...
<body>
   ...
   <nav class="full-box dashboard-Navbar">
	...
	<section class="full-box cover dashboard-sideBar">
		...
		<ul class="list-unstyled full-box dashboard-sideBar-Menu">
           ...
           <a href="../RegistroAdmin.html"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Administradores</a>
                    ...
                    <center>
                    <a href="../categorias.html" class="btn btn-info">
			  			<i class="zmdi zmdi-plus"></i> &nbsp; AGREGAR NUEVA CATEGORIA
			  		</a>
   </center>
    <hr class="hr">
     <div class="container">
    ...
    require_once "conexionBD.php";      
        ...
        $consulta="SELECT CODIGO,NOMBRE FROM CATEGORIA";
        ...
        while($row=$consulta2->fetch_array(MYSQLI_ASSOC)){
            ...
            echo "<tr>
                ...
                <td><a href='Actualizar_categ.php?CODIGO=".$row['CODIGO']."'>Actualizar</a></td>
                 <td><a href='eliminar-categoria.php?CODIGO=".$row['CODIGO']."'>Eliminar</a></td>
